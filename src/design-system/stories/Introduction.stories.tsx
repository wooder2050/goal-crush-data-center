...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Goal Crush Design System - 스포츠 데이터 플랫폼을 위한 포괄적인 디자인 시스템',
      },
    },
  },
};
    ...
    <div className="max-w-4xl mx-auto p-8 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          스포츠 데이터 플랫폼을 위한 포괄적인 디자인 시스템입니다. 
          일관된 사용자 경험을 제공하는 재사용 가능한 컴포넌트와 디자인 토큰을 제공합니다.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-orange-50 p-6 rounded-lg">
          <h3 className="text-lg font-semibold mb-2 text-orange-900">스포츠 특화</h3>
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="border rounded-lg p-6">
            <h3 className="text-lg font-semibold mb-3 text-[#ff4800]">🎨 디자인 토큰</h3>
          ...
          <div className="border rounded-lg p-6">
            <h3 className="text-lg font-semibold mb-3 text-[#ff4800]">🧩 컴포넌트</h3>
            <ul className="space-y-2 text-sm text-gray-600">
          ...
          <div className="border rounded-lg p-6">
            <h3 className="text-lg font-semibold mb-3 text-[#ff4800]">📱 반응형</h3>
            <ul className="space-y-2 text-sm text-gray-600">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">역동적인 오렌지-레드 컬러</div>
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-4 mt-6 text-sm">
            <div>
              <h4 className="font-semibold mb-2">🏆 스포츠 컨텍스트</h4>
              <p className="text-gray-600">트로피 아이콘, 팀 컬러, 선수 이미지</p>
            </div>
            <div>
              <h4 className="font-semibold mb-2">🇰🇷 한국어 지원</h4>
              <p className="text-gray-600">한국어 콘텐츠에 최적화된 타이포그래피</p>
            </div>
            <div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <ol className="space-y-3 text-sm">
            <li className="flex items-start space-x-3">
              <span className="bg-blue-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-medium">1</span>
              <span><strong>Design Tokens</strong> 섹션에서 기본 토큰을 확인하세요</span>
            </li>
            <li className="flex items-start space-x-3">
              <span className="bg-blue-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-medium">2</span>
              <span><strong>Components</strong> 섹션에서 사용 가능한 UI 요소를 탐색하세요</span>
            </li>
            <li className="flex items-start space-x-3">
              <span className="bg-blue-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-medium">3</span>
              <span><strong>Examples</strong>에서 일반적인 사용 패턴을 확인하세요</span>
            </li>
            <li className="flex items-start space-x-3">
              <span className="bg-blue-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-medium">4</span>
              <span><strong>Guidelines</strong>에서 구현 모범 사례를 검토하세요</span>
            </li>
          </ol>
        </div>
      </div>
