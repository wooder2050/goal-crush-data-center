...
const meta: Meta<typeof Typography> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Typography component system with consistent text styles and semantic variants. Includes convenience components for common text elements.',
      },
    },
  },
  argTypes: {
  ...
  render: () => (
    <div className="space-y-6">
      ...
      <Typography variant="body">
        Body - 본문 텍스트입니다. Goal Crush 플랫폼에서 사용되는 기본 텍스트 스타일로, 
        가독성을 위해 적절한 줄 간격과 색상이 적용되어 있습니다.
      </Typography>
...
export const ConvenienceComponents: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <Body>
        Body 컴포넌트 - 본문 텍스트를 위한 편의 컴포넌트입니다. 
        별도의 variant 속성 없이 바로 사용할 수 있습니다.
      </Body>
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <Body>
          as 속성을 사용하여 스타일과 별개로 적절한 HTML 요소를 선택할 수 있습니다.
        </Body>
      </div>
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <H3>게임 방법</H3>
          <Body>
            팀 편성은 매달 첫째~둘째 주 + 셋째 주 화요일까지 가능하며, 
            같은 팀에서 최대 2명까지 선택할 수 있습니다.
          </Body>
        </div>
      </div>
  ...
  render: () => (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <Body className="text-green-700">선수가 성공적으로 추가되었습니다.</Body>
        
        <H3 className="text-red-600">에러 메시지</H3>
        <Body className="text-red-700">선수 선택에 실패했습니다. 다시 시도해주세요.</Body>
        ...
        <Caption className="text-gray-500">마지막 업데이트: 2025.9.7 22:30</Caption>
      </div>
    </div>
  ),
};
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        <H2>반응형 타이포그래피</H2>
        <Body>
          Tailwind CSS의 반응형 클래스를 사용하여 화면 크기에 따라 
          텍스트 크기를 조절할 수 있습니다.
        </Body>
      </div>
