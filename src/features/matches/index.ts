...
export { default as Season3ChallengeResults } from './components/Season3ChallengeResults';
...
export { default as Season5ChallengeResults } from './components/Season5ChallengeResults';
