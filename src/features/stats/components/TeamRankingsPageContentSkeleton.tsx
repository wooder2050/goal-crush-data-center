...
export default function TeamRankingsPageContentSkeleton() {
  return (
      ...
      <Section padding="sm">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
            ...
            <div className="h-8 sm:h-12 w-32 sm:w-48 bg-gray-200 rounded animate-pulse"></div>
          </div>
          <div className="h-6 sm:h-7 w-64 sm:w-80 bg-gray-200 rounded mx-auto animate-pulse"></div>
        </div>
                ...
                <div className="grid grid-cols-4 gap-3">
                  {[1, 2, 3, 4].map((j) => (
                    <div key={j} className="text-center">
                      <div className="h-6 w-12 bg-gray-200 rounded mb-1 mx-auto animate-pulse"></div>
                      <div className="h-3 w-8 bg-gray-200 rounded mx-auto animate-pulse"></div>
                    </div>
                  ))}
                </div>
              </Card>
