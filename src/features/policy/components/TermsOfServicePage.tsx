      ...
      <Section padding="sm" className="pt-16 pb-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            골크러쉬 데이터센터 서비스를 이용하시기 전에
            다음 약관을 반드시 확인해주시기 바랍니다.
          </p>
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p className="leading-relaxed">
                  이 약관은 골크러쉬 데이터센터(이하 &ldquo;회사&rdquo;)가 제공하는 
                  &ldquo;골 때리는 그녀들&rdquo; 관련 데이터 서비스(이하 &ldquo;서비스&rdquo;)의 
                  이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 
                  기타 필요한 사항을 규정함을 목적으로 합니다.
                </p>
                <div className="bg-[#ff4800]/5 rounded-lg p-4 border-l-4 border-[#ff4800]">
                  <p className="text-sm font-medium text-[#ff4800]">
                    본 서비스는 &ldquo;골 때리는 그녀들&rdquo; 방송 관련 축구 데이터를 
                    체계적으로 제공하는 정보 서비스입니다.
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-sm">
                      회사가 제공하는 골크러쉬 데이터센터 웹사이트 및 관련 서비스 일체
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="font-semibold mb-2">2. &ldquo;회원&rdquo;</h4>
                    <p className="text-sm">
                      회사와 서비스 이용계약을 체결하고 이용자 아이디(ID)를 부여받은 자
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="font-semibold mb-2">3. &ldquo;비회원&rdquo;</h4>
                    <p className="text-sm">
                      회원가입을 하지 않고 회사가 제공하는 서비스를 이용하는 자
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="font-semibold mb-2">4. &ldquo;게시물&rdquo;</h4>
                    <p className="text-sm">
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    회사는 관련 법률에 위배되지 않는 범위에서 이 약관을 개정할 수 있으며, 
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-purple-50 rounded-lg p-4 border-l-4 border-purple-500 mt-4">
                  <p className="text-sm text-purple-700">
                    <strong>서비스 이용시간:</strong> 연중무휴 24시간 제공을 원칙으로 하나, 
              ...
              <div className="space-y-4 text-gray-700">
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    ...
                    회원정보를 기입한 후 이 약관에 동의한다는 의사표시를 함으로써 회원가입을 신청합니다.
                  </p>
                </div>
                <div>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-red-50 rounded-lg p-4 border-l-4 border-red-500">
                    <h4 className="font-semibold text-red-800 mb-2">금지행위</h4>
                  ...
                  <div className="bg-yellow-50 rounded-lg p-4 border-l-4 border-yellow-500">
                    <h4 className="font-semibold text-yellow-800 mb-2">준수사항</h4>
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    회사는 서비스에 게재된 정보의 정확성, 신뢰성에 대해 최선을 다하나, 
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    회사는 회원 간 또는 회원과 제3자 간의 거래에 대해서는 책임을 지지 않습니다.
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                  <p className="text-sm text-blue-700">
                    <strong>부칙:</strong> 이 약관은 {lastUpdated}부터 시행됩니다.
                  </p>
                </div>
              </div>
            </CardContent>
