...
import { Calendar, Database, Eye, Lock, Mail,Phone, Shield } from 'lucide-react';
      ...
      <Section padding="sm" className="pt-16 pb-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            골크러쉬 데이터센터는 사용자의 개인정보를 소중히 여기며,
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="space-y-2 pl-6">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="inline-block w-2 h-2 bg-[#ff4800] rounded-full mt-2 flex-shrink-0"></span>
                    <span>마케팅 및 광고: 이벤트 정보 제공, 광고성 정보 전송</span>
                  </li>
                </ul>
              </div>
            </CardContent>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold mb-3 text-gray-800">필수항목 (Supabase 수집)</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-3 text-gray-800">자동 수집 정보</h3>
                  <ul className="space-y-2 text-gray-700 pl-4">
                    <li>• IP 주소, 쿠키, 방문기록</li>
                    <li>• 서비스 이용기록, 접속로그</li>
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                  <p className="font-semibold text-blue-800 mb-2">제3자 제공 현황</p>
                  <p className="text-blue-700 text-sm mb-3">
                    서비스 제공을 위해 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
                  </p>
                  <div className="bg-white rounded-lg p-3">
                    <p className="font-semibold text-blue-800 text-sm">Supabase (사용자 인증)</p>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="space-y-4">
                    <div className="bg-white rounded-lg p-4 border-l-4 border-blue-500">
                      <h4 className="font-semibold text-blue-800">Supabase Inc. (사용자 인증 및 데이터베이스)</h4>
                      <div className="mt-2 space-y-1 text-sm text-gray-600">
                        <p><strong>위탁업무:</strong> 회원가입, 로그인 인증, 사용자 데이터 저장</p>
                        <p><strong>개인정보 항목:</strong> 이메일, 닉네임, 로그인 기록, 서비스 이용 기록</p>
                        <p><strong>보유기간:</strong> 회원 탈퇴 시까지 또는 위탁계약 종료시까지</p>
                        <p><strong>처리국가:</strong> 미국 (SOC 2 Type II, ISO 27001 인증)</p>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-4 border-l-4 border-green-500">
                      <h4 className="font-semibold text-green-800">Vercel Inc. (웹사이트 호스팅)</h4>
                      <div className="mt-2 space-y-1 text-sm text-gray-600">
                        <p><strong>위탁업무:</strong> 웹사이트 호스팅, CDN 서비스</p>
                        <p><strong>개인정보 항목:</strong> IP 주소, 접속 로그, 쿠키</p>
                        <p><strong>보유기간:</strong> 서비스 제공 기간 동안</p>
                        <p><strong>처리국가:</strong> 미국</p>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-4 border-l-4 border-orange-500">
                      <h4 className="font-semibold text-orange-800">Google LLC (웹사이트 분석)</h4>
                      <div className="mt-2 space-y-1 text-sm text-gray-600">
                        <p><strong>위탁업무:</strong> 웹사이트 이용 현황 분석</p>
                        <p><strong>개인정보 항목:</strong> IP 주소(익명화), 방문 기록, 기기 정보</p>
                        <p><strong>보유기간:</strong> 26개월 (Google Analytics 정책)</p>
                        <p><strong>처리국가:</strong> 미국</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-yellow-50 rounded-lg p-4 border-l-4 border-yellow-500 mt-4">
                  <p className="text-sm text-yellow-800">
                    <strong>해외 전송 관련:</strong> 위 업체들은 모두 적절한 보안 조치를 취하고 있으며, 
                    개인정보보호법에 따른 해외 전송 요건을 충족합니다. 
                    상세한 보안 정책은 각 업체의 개인정보처리방침을 참고하시기 바랍니다.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-red-50 rounded-lg p-4 border-l-4 border-red-500 mt-4">
                  <p className="font-semibold text-red-800 mb-2">권리 행사 방법</p>
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-[#ff4800]/5 rounded-lg p-6 border border-[#ff4800]/20">
                  <h3 className="font-bold text-[#ff4800] mb-4">개인정보 보호책임자</h3>
                  <div className="space-y-2 text-sm">
                    <p><strong>직책:</strong> 운영진</p>
                    <p><strong>연락처:</strong> 커뮤니티 게시판 문의</p>
                    <p><strong>이메일:</strong> privacy@gtndatacenter.com</p>
                  </div>
                </div>
              </div>
            </CardContent>
